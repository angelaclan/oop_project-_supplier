...
if (count($products) == 0) $columnNames = [];
else  {
    $columnNames = $products[0]->columnNames ();
    $key = array_search("id_supplier", $columnNames);
...
<header id="headerformpage">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4"><h3>Product List</h3></div>
            <div class="col-md-4">
...
<div class="container">
    <div class="row">
        <div class="col-md-4 offset-md-8">
            ...
            <a href = 'product_frontend.php?action=add'>Add product</button></a></p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <?php
            ...
            foreach($products as $product){
                ...
                echo "<td> <a href = 'product_frontend.php?action=edit&id=". $product->getId(). "'>
                ...
                // for being able to recognize the concerned employee
                echo "<td> <a href= 'product_backend.php?&action=delete&id=" . $product->getId() . "'>
